...
public class GetGroupService extends AsyncTask<Void, Void, Boolean> {
	...
	public GetGroupService(String userName,
			String password) {
	...
	protected Boolean doInBackground(Void... params) {
        ...
        {	
            ...
            HttpPost httppost = new HttpPost("http://66.175.218.17/getGroups.php");
