...
public class GetReminderService extends AsyncTask<Void, Void, Boolean> {
	private String userName;
	private String password;
	public static String result;
	public GetReminderService(String userName, String password) {
	...
	protected Boolean doInBackground(Void... params) {
        ...
        {	
            ...
            HttpPost httppost = new HttpPost("http://66.175.218.17/getReminders.php");
