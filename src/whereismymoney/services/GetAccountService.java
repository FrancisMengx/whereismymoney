...
public class GetAccountService extends AsyncTask<Void, Void, Boolean> {
	private String userName;
	private String password;
	public static String result;
	public static HttpResponse response;
	
	public GetAccountService(String userName, String password) {
	...
	protected Boolean doInBackground(Void... params) {
        ...
        {	
            ...
            HttpPost httppost = new HttpPost("http://66.175.218.17/accountList.php");
