...
public class RegisterActivity extends Activity {
	...
	public void attemptLogin() {
		...
		this.mPasswordConfirm = mPasswordConfirmView.getText().toString();
		...
		if(!this.mPassword.equals(this.mPasswordConfirm)){
			focusView = mPasswordConfirmView;
			mPasswordConfirmView.setError(getString(R.string.confirm_fail));
			cancel = true;
		}
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			...
			try {
	            ...
	            HttpPost httppost = new HttpPost("http://66.175.218.17/register.php");
